...
the full tablet administration, an inter-rater reliability study was also conducted in 2017-18. The inter-rater reliability study included 33 Qualified
...
administration. Included in the future of the five-year plan
...
The Oregon State Board of Education (SBE) adopted new, challenging academic content standards, the \color{link}[Common Core State Standards (CCSS)](https://www.oregon.gov/ode/educator-resources/standards/Pages/default.aspx)\color{black}, in English language
...
Similarly, the SBE adopted the \color{link}[Next Generation Science Standards (NGSS)](https://www.oregon.gov/ode/educator-resources/standards/science/Pages/Science-Standards.aspx)
\color{black}  on March
...
Science (ORSci) standards that were adopted in 2009. 

The newly adopted academic content standards were then reduced in depth, breadth, and complexity through a process called essentialization. The new \color{link}[Essentialized Assessment Frameworks (EAFs)](http://www.brtprojects.org/publications/training-modules)
\color{black}   were then used for item writing for the ORExt. The tables below provide examples of essentialized standards in grades 5, 8, &
11 in the subject areas of English language arts (ELA), mathematics, and
science. In the right column are designations for estimated difficulty of an item:
...
The new Essentialized Assessment Frameworks (EAFs) are publicly available. A User Guide is provided to instruct educators regarding the intended uses of the
...
for a summary of participation. Documentation of this requirement is provided within the Annual Performance
...
state performance is published in the 2016-17 \color{link}[Statewide Report Card](http://www.oregon.gov/ode/schools-and-districts/reportcards/Documents/rptcard2017.pdf)
\color{black} (see *Appendix*
1.5, pages 1-11 for student and teacher demographics and pages 20-47 for
...
distributed via the \color{link}[Assessment and Accountability Updates](http://www.oregon.gov/ode/educator-resources/assessment/Pages/Assessment-and-Accountability-Update.aspx)
\color{black} listserve, as well. ODE uses this system to communicate information that is relevant
...
site annually since that time. The \color{link}[sign language training](http://lms.brtprojects.org) 
\color{black} process included videos of interpreters
...
and Qualified Trainers (QTs) is provided in *Appendices* 2.3B.1-2.3B.8. Through an online distribution and assessment system, \color{link}[QA/QT Training and Proficiency](https://or.k12test.com/) 
\color{black} is determined anually. This website hosts all resources
...
The tables below contain data from the \color{link}[Oregon Extended Assessment Training and Proficiency Website](http://or.k12test.com/)
...
In addition, all technical assistance questions that we receive from the field as part of our *HelpDesk* are documented. The log of the technical assistance provision is reviewed each month, as well as annually, in order to determine what aspects of our assessment system need further clarification or improvement. With the launch of the full tablet app the helpdesk received many more inquiries than in previous years. Around 48% of the inquiries were end user issues such as slow internet connection, trouble with individual tablets, users needing the exit pin, etc. About 29% of inquiries related to the ODE database. This included things like credential verification, districts with no Qualified Trainer, and students registered in different districts not appearing on rosters. About 11% of inquiries were coded as ‘Training’ indicating many of these issues could be solved with more emphasis on certain areas during the fall trainings. Only 9% of inquiries were specific to the BRT tablet system and will be addressed in updates for the 2018-19 testing window. And only 3% of inquiries were related to the paper/pencil administration. 
...
administration for the \color{link} [Oregon K12 website](https://or.k12test.com)\color{black}, (secure website, but see screenshot
...
conducted online using the secure \color{link}[Distributed Item Review (DIR)](http://brtitemreview.com) 
\color{black} platform (secure website,
but see *Appendix* 3.1B for a system overview).

For the 2017-2018 school year, all paper/pencil secure test distribution and
data entry was hosted by \color{link}[ODE's secure file transfer system](https://district.ode.state.or.us/apps/login/) \color
{black}, which is a
...
website](https://or.k12test.com) \color{black} or \color{link} [ODE's secure file transfer system](https://district.ode.state.or.us/apps/login/) \color{black} website, as
...
to complexity levels: low - medium - high, comparable to Webb's DOK.
...
According to the independent linkage study report, the
...
Essentialized Assessment Frameworks" (68.4% Strongly Agree & Agree). In
...
what my students with significant cognitive disabilities are able to do" (84.8%
Strongly Agree & Agree). The consequential validity results demonstrate that
the ORExt is sampling academic domains that the field of QAs and QTs deem
appropriate in the area of academics. See *Appendix* 2.3B.10 for complete consequential vailidity study results. 
...
Student reported exceptionalities included Intellectual Disability (ID 10), Hearing
Impairment (HI 20), Visual Impairment (VI 40), Deaf-Blindness (DB 43), Communication
Disorder (CD 50), Emotional Disturbance (ED 60), Orthopedic Impairment (OI 70), Traumatic
Brain Injury (TBI 74), Other Health Impairment (OHI 80), Autism Spectrum Disorder
(ASD 82), and Specific Learning Disability (SLD 90). The majority of students who
...
levels, though the results suggest small losses across grades in math.These scales were selected to clearly determine whether scores are on the same
...
Students with VI are again the lowest performing group. Students with SLD are consistently outperforming most peers.

Students with VI are consistently the lowest performing group, which led to
concerns regarding test accessibility. 
...
blueprints are supported by the \color{link}[ORExt Extended Assessment Frameworks(http://www.brtprojects.org/publications/training-modules) \color{black},
...
across all grades and content areas. The item person distributions provided below demonstrate that
...
The ORExt was administered in only form per subject area and grade level for the 2017-18 school
...
module to increase the standardization of \color{link}[ASL administration](http://lms.brtprojects.org)
\color{black} for its statewide assessments.
...
*Appendix* 2.3B.9 is the Helpdesk log report that summarizes all of the technical assistance
...
*Appendix* 2.6 is the data entry guide. The guide explains the paper/pencil data entry process located on ODE's secure server. ]

#### Appendices 2.6A

*Appendix* 2.6A is the ORExt Test Application User Guide. With 2017-18 the first year the tablet/web-based platform was available for all grade level and subject area tests, this guide walked through the system requirements, download/login instructions, testing process, and troubleshooting. 
