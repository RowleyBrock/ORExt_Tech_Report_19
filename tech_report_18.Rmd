...
\newpage
![](peer_rev/PeerReview1.pdf)

\newpage
![](peer_rev/PeerReview2.pdf)

\newpage

![](peer_rev/PeerReview3.pdf)

\newpage

![](peer_rev/PeerReview4.pdf)

\newpage

![](peer_rev/PeerReview5.pdf)

\newpage

![](peer_rev/PeerReview6.pdf)
...
L (low), M (medium), and H (high). \color{link} [Complete EAF
Spreadsheets](http://www.brtprojects.org/publications/training-modules)
\color{black}

See *Appendix* 1.1 for a User Guide that explains the development process and
intended uses for the EAFs.

![](Standards/Grade5.pdf)

\newpage
![](Standards/Grade8.pdf)

\newpage
![](Standards/Grade11.pdf)
...
![](Essentialization/Essentialization.pdf)
...
reports link](http://www.oregon.gov/ode/educator-resources/assessment/Pages/Assessment-Group-Reports-for-2014-2015-and-2015-2016.aspx.)
\color{black}
...
with an 80% required for passing (8/10 items correct). In 2016-17, the site was
used to train 60 participants. All participants passed the assessment on the
first attempt. The overall average score on the proficiency test was 97.6%.
...
link](https://or.k12test.com.) \color{black}This website hosts all resources and
information needed to administer, score, report, and interpret the results from
the ORExt. The website also includes proficiency assessments that are required
for all QAs and QTs who may administer the ORExt. QTs are directly trained by
ODE and BRT staff as part of a train the trainers model. QTs then provide direct
...
distribution and data entry system located at \color{link} [Secure file
link](https://district.ode.state.or.us/apps/login/) \color{black} (secure
website, but see screenshot below for reference). A data entry guide is provided
in Appendix 2.6.
...
systems. See *Appendix* 2.6 for additional data entry expectations for 2016-17.
