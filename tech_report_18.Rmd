...
Essentialized Assessment Frameworks" (85% Strongly Agree or Agree). In
...
what my students with significant cognitive disabilities are able to do" (85%
Strongly Agree or Agree). The consequential validity results demonstrate that
...
The following table is a key for Elibibility Codes:
\FloatBarrier
![](tifs/disabcodes.png)
The following tables provide information regarding average student performance
...
make performance comparisons feasible. Accommodations information was collected in this year's assessment. A study on the effect of the use of different accommodations will be conducted and reported in the 2018-19 technical report. 
