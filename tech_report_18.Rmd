---
title: 'Oregon Extended Assessment Analyses: 2018'
author:
  - Brock Rowley
  - Daniel Anderson
  - Sevrina Tindal
...
2017-18, so the 2014-15 test specifications are the most current available.
...
## ELA
g3ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G3.csv", setclass = "tbl_df")
g4ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G4.csv", setclass = "tbl_df")
g5ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G5.csv", setclass = "tbl_df")
g6ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G6.csv", setclass = "tbl_df")
g7ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G7.csv", setclass = "tbl_df")
g8ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G8.csv", setclass = "tbl_df")
g11ela <- import("./data/amos/ELA_2018/ELA2017_AMO_G11.csv", setclass = "tbl_df")

## Reading
g3Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade3_FinalPfile.csv")
g4Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade4_FinalPfile.csv")
g5Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade5_FinalPfile.csv")
g6Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade6_FinalPfile.csv")
g7Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade7_FinalPfile.csv")
g8Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade8_FinalPfile.csv")
g11Read <- read.csv("./data/amos/ELA_2018/ReadingSubscores/Rdg1617_Grade11_FinalPfile.csv")


## Writing
g3wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade3_FinalPfile.csv")
g4wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade4_FinalPfile.csv")
g5wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade5_FinalPfile.csv")
g6wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade6_FinalPfile.csv")
g7wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade7_FinalPfile.csv")
g8wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade8_FinalPfile.csv")
g11wri <- read.csv("./data/amos/ELA_2018/WritingSubscores/Wri1617_Grade11_FinalPfile.csv")

## Math
g3math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G3.csv")
g4math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G4.csv")
g5math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G5.csv")
g6math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G6.csv")
g7math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G7.csv")
g8math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G8.csv")
g11math <- read.csv("./data/amos/Math_2018/Math2017_AMO_G11.csv")

## Science
g5sci <- read.csv("./data/amos/Science_2018/Sci2017_AMO_G5.csv")
g8sci <- read.csv("./data/amos/Science_2018/Sci2017_AMO_G8.csv")
g11sci <- read.csv("./data/amos/Science_2018/Sci2017_AMO_G11.csv")
```
...
##Inter-Rater-Reliability data anaylsis 
 IntRateReli <- read.csv("./data/irr/RaterReliability.csv")
