...
eth_descrip_tbls <- ode %>% 
  ...
  mutate(content_area = case_when(content_area == "ela" ~ "ELA",
                                  content_area == "math" ~ "Math",
                                  content_area == "sci" ~ "Sci"),
         race_eth = case_when(race_eth == "asian" ~ "Asian",
                              race_eth == "black" ~ "Black",
                              race_eth == "amer_indian_alskn_ntv" ~ "Am Ind",
                              race_eth == "multiracial" ~ "Multiracial",
                              race_eth == "pac_islndr" ~ "Pac Isl",
                              race_eth == "white" ~ "White",
                              race_eth == "Hispanic" ~ "Hispanic",
                              is.na(race_eth) ~ "Missing")) %>% 
...
disab_descrip_captions <- paste0("Grade ", 
                              ...
                              " Means/Exceptionality Status: 2018-19")
