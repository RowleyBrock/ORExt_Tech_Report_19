setwd("/Users/nadfarley/Documents/AlignAssess_Folder/AlignAssess/ODE_2016_17/2017TechnicalReport/ORExt_G3_8")
library(tidyverse)
library(sundry)
...
G3ELA <- subset(G3ELA, ,c(20:22,30,32:33))
G4ELA <- subset(G4ELA, ,c(20:22,30,32:33))
G5ELA <- subset(G5ELA, ,c(20:22,30,32:33))
G6ELA <- subset(G6ELA, ,c(20:22,30,32:33))
G7ELA <- subset(G7ELA, ,c(20:22,30,32:33))
G8ELA <- subset(G8ELA, ,c(20:22,30,32:33))
G11ELA <- subset(G11ELA, ,c(20:22,30,32:33))

G3Math <- subset(G3Math, ,c(20:22,30,32:33))
G4Math <- subset(G4Math, ,c(20:22,30,32:33))
G5Math <- subset(G5Math, ,c(20:22,30,32:33))
G6Math <- subset(G6Math, ,c(20:22,30,32:33))
G7Math <- subset(G7Math, ,c(20:22,30,32:33))
G8Math <- subset(G8Math, ,c(20:22,30,32:33))
G11Math <- subset(G11Math, ,c(20:22,30,32:33))

G5Sci <- subset(G5Sci, ,c(20:22,30,32:33))
G8Sci <- subset(G8Sci, ,c(20:22,30,32:33))
G11Sci <- subset(G11Sci, ,c(20:22,30,32:33))

### Read in exceptionality file ++++++++++++++++++++++++
Disab17 <- read.csv("Disab17.csv")
head(Disab17)
...
g3ELAIfile <- read.csv("g3ELAifiles17.csv")
g4ELAIfile <- read.csv("g4ELAifiles17.csv")
g5ELAIfile <- read.csv("g5ELAifiles17.csv")
g6ELAIfile <- read.csv("g6ELAifiles17.csv")
g7ELAIfile <- read.csv("g7ELAifiles17.csv")
g8ELAIfile <- read.csv("g8ELAifiles17.csv")
g11ELAIfile <- read.csv("g11ELAifiles17.csv")
nms(g3ELAIfile)
head(g3ELAIfile, 48)
str(g3ELAIfile)
...
g3MathIfile <- read.csv("g3Mathifiles17.csv")
g4MathIfile <- read.csv("g4Mathifiles17.csv")
g5MathIfile <- read.csv("g5Mathifiles17.csv")
g6MathIfile <- read.csv("g6Mathifiles17.csv")
g7MathIfile <- read.csv("g7Mathifiles17.csv")
g8MathIfile <- read.csv("g8Mathifiles17.csv")
g11MathIfile <- read.csv("g11Mathifiles17.csv")
...
g5SciIfile <- read.csv("g5Sciifiles17.csv")
g8SciIfile <- read.csv("g8Sciifiles17.csv")
g11SciIfile <- read.csv("g11Sciifiles17.csv")
...
#### plots thinner lines ================
plot(table(g3ELA2015$PointMeasureCorr))
